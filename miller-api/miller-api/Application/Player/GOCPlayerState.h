...
namespace app::player {
    ...
    public:
        ...
        virtual bool Step(PlayerHsmContext& context, float deltaTime) override { return 0; }
        virtual bool Update(PlayerHsmContext& context, hh::fnd::UpdatingPhase phase, float deltaTime) override;
        virtual bool UpdateAsync(PlayerHsmContext& context, hh::fnd::UpdatingPhase phase, float deltaTime) override { return 0; }

        virtual bool InitPlayerState(PlayerHsmContext& context) { return 0; }
